...
//!
//! This module provides a general-purpose XML parser that is validated to handle
//! the XML files of certain nikāyas with very similar structure.
//!
//! This parser is also used to attempt to parse nikāyas without a specific parser.
//!

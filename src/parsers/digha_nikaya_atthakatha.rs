//! Dīgha Nikāya Aṭṭhakathā (commentary) XML fragment parser
...
pub struct DighaNikayaAtthakatha;

impl DighaNikayaAtthakatha {
    pub fn new() -> Self {
...
impl XmlParser for DighaNikayaAtthakatha {

//! Aṅguttara Nikāya Aṭṭhakathā (commentary) XML fragment parser
...
pub struct AnguttaraNikayaAtthakatha;

impl AnguttaraNikayaAtthakatha {
    pub fn new() -> Self {
...
impl XmlParser for AnguttaraNikayaAtthakatha {

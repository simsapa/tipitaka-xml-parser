...
/// frag_idx values have shifted by +1. The new fragment "9. Khayadhammasuttaṃ"
/// is now correctly split from frag_idx 177.
///
/// frag_idx 275: cst_code sn3.9.1.17-46 should get sc_code sn30.17-46
/// frag_idx 276: cst_code sn3.10.1.1 should get sc_code sn31.1
/// frag_idx 277: cst_code sn3.10.1.2 should get sc_code sn31.2
///
/// This works because:
...
fn test_s0303m_sc_code_propagation_sn9_to_sn10() {
    ...
    assert_eq!(frag_275.cst_code, Some("sn3.9.1.17-46".to_string()), 
        "frag_idx 275 should have cst_code sn3.9.1.17-46");
    ...
    assert_eq!(frag_276.cst_code, Some("sn3.10.1.1".to_string()), 
        "frag_idx 276 should have cst_code sn3.10.1.1");
    assert_eq!(frag_276.sc_code, Some("sn31.1".to_string()), 
        "frag_idx 276 should have sc_code sn31.1");
    ...
    assert_eq!(frag_277.cst_code, Some("sn3.10.1.2".to_string()), 
        "frag_idx 277 should have cst_code sn3.10.1.2");
    assert_eq!(frag_277.sc_code, Some("sn31.2".to_string()), 
        "frag_idx 277 should have sc_code sn31.2");
    assert!(frag_277.sc_sutta.is_some(), 
        "frag_idx 277 should have sc_sutta");
}

/// Test that range cst_codes get range sc_codes.
///
/// frag_idx 182 has cst_code "sn3.2.3.1-11" (a range of 11 suttas)
...
fn test_s0303m_range_cst_code_to_sc_code() {
    ...
    assert_eq!(frag_182.cst_code, Some("sn3.2.3.1-11".to_string()), 
        "frag_idx 182 should have cst_code sn3.2.3.1-11");
